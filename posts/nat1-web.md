...
draft: false
coverImage: /img/nat1-web-0aa77bad-482a-4b65-9a19-4f35acb570ba.webp
---
...
![](/img/nat1-web-bdd05652-4676-418f-b8aa-1dfc5b3dfab1.webp)

打开开发者工具后，再保存，确保抓到这样的包，保存备用
![](/img/nat1-web-60e191a3-c4d8-40a2-b9b7-13af0fae38ab.webp)

将 `dash.cloudflare.com/api` 改为 `api.cloudflare.com/client` 。将刚才获得的红框内的内容填写到 `rules` 后面

![](/img/nat1-web-b1a7a07c-7b4b-49ff-a152-938e30d93ee6.webp)
...
![](/img/nat1-web-559bce4c-ed44-4523-a623-7058ef1082dc.webp)
