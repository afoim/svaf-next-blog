...
![](/img/hack-lskypro-2025-08-22-04-21-45-8d13151d19e627bd9e614517aeb5dbe6.webp)

系统升级已Hook，定死版本

![](/img/hack-lskypro-2025-08-22-04-22-19-image.webp)
...
![](/img/hack-lskypro-a5fd2695975981d785cea1af5c0ee9588dc1b9ee.webp)

默认Burp仅拦截请求，不拦截响应，需要手动设置一下

![](/img/hack-lskypro-2690f8470df19d0c4a0f134835a7cbc95c9798fd.webp)

然后启用拦截

![](/img/hack-lskypro-52650c556acc9406923fb824823fe3a04e153d5d.webp)

当你通过官方教程到执行 `./install.sh` 的时候

会要求输入域名和授权密钥，域名填你自己的，否则之后上传的图片的预览地址将会不正确！授权密钥随便填！

![](/img/hack-lskypro-67b17d4c5f5d7ba8d2e2ee348d19bc01c6d42b1d.webp)

回车，会开始转圈圈

![](/img/hack-lskypro-fb540faa472d476e8d6b05a04d01be5a19adb236.webp)

查看Burp，发现多了一个请求，首先点击放行

![](/img/hack-lskypro-8a6dd20b7ad55a9fdad795be358b8486b75de5b7.webp)

现在出现了响应，并且状态码为401

![](/img/hack-lskypro-ce862cb4eeefc2a7a52bea44e4e6ab137a7cd3da.webp)

响应那块是可以编辑的，用 https://r2.072103.xyz/lsky_success_223.txt 中的内容替换原响应。然后点击放行

![](/img/hack-lskypro-b8545b978629815aec471489890a0be62f0a8f89.webp)

恭喜，通过授权了

![](/img/hack-lskypro-fdda3a54fd4a6da5d0c0c9d5ac0fbd5b79ef2b51.webp)
