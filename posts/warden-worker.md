...
![](/img/warden-worker-warden-worker-25.webp)

替换 **wrangler.jsonc** 的数据库ID

![](/img/warden-worker-warden-worker-26.webp)
...
![](/img/warden-worker-warden-worker-27.webp)
...
![](/img/warden-worker-warden-worker-29.webp)
...
![](/img/warden-worker-warden-worker-30.webp)
...
![](/img/warden-worker-warden-worker-31.webp)

前往控制台绑定域名（若路由需要手动写一条解析到Cloudflare）

![](/img/warden-worker-warden-worker-28.webp)
...
![](/img/warden-worker-warden-worker-32.webp)
...
![](/img/warden-worker-warden-worker-33.webp)
