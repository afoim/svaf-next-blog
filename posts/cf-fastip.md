...
![](/img/cf-fastip-cf-fastip.png)

最后写一条DNS解析到想要的优选域名，完事！

![](/img/cf-fastip-cf-fastip-1.png)
...
![](/img/cf-fastip-56752d54-26a5-46f1-a7d9-a782ad9874cb.webp)

类似这样填写：

![](/img/cf-fastip-d025398c-39e3-4bd7-8d8f-2ce06a45007d.webp)
...
![](/img/cf-fastip-cf-fastip-4.png)

接着，你需要绑定一个自定义域

![](/img/cf-fastip-cf-fastip-5.png)

接着，前往你的域名 - 规则 - Cloud Connector

![](/img/cf-fastip-cf-fastip-6.png)

![](/img/cf-fastip-cf-fastip-7.png)

![](/img/cf-fastip-cf-fastip-8.png)
...
![](/img/cf-fastip-cf-saas-1.webp)

![](/img/cf-fastip-cf-saas-2.webp)

![](/img/cf-fastip-cf-saas-3.webp)
...
3. 点击添加自定义主机名。设置一个自定义主机名，比如 `onani.cn`，然后选择**自定义源服务器**，填写第一步的域名，即 `xlog.acofork.cn`。
   ...
   ![QmRYrwjeDMDQCj8G9RYkpjC3X4vpwE77wpNpbqKURwBber.webp](/img/cf-fastip-f6170f009c43f7c6bee4c2d29e2db7498fa1d0dc.webp)

4. 继续在你的辅助域名添加一条解析。CNAME到优选节点：如cloudflare.182682.xyz，**不开启cf代理**
   ![QmNwkMqDEkCGMu5jsgE6fj6qpupiqMrqqQtWeAmAJNJbC4.webp](/img/cf-fastip-4f9f727b0490e0b33d360a2363c1026003060b29.webp)

5. 最后在你的主力域名添加解析。域名为之前在辅助域名的自定义主机名（onani.cn），目标为刚才的cdn.acofork.cn，**不开启cf代理**
   ![QmeK3AZghae4J4LcJdbPMxBcmoNEeF3hXNBmtJaDki8HYt.webp](/img/cf-fastip-6f51cb2a42140a9bf364f88a5715291be616a254.webp)

6. 优选完毕，确保优选有效后尝试访问
   ![](/img/cf-fastip-cf-fastip-10.webp)
...
2. 如果是外域，SaaS后再添加路由即可，就像：
   ![](/img/cf-fastip-cf-fastip-12.webp)
...
![](/img/cf-fastip-cf-fastip-3.webp)

![](/img/cf-fastip-cf-fastip-2.webp)
