...
![](/img/translations-betterstack-2025-08-28-18-57-52-image.webp)

至于 `月`，我这里则是直接这样写：

![](/img/translations-betterstack-2025-08-28-18-58-30-image.webp)

另外，BetterStack 会把 `UTC+8` 自作聪明地写成 `CST`。但 `CST` 本身是一个有歧义的时区缩写，所以这里同样建议通过硬编码来修正。

![](/img/translations-betterstack-2025-08-28-18-56-39-image.webp)

![](/img/translations-betterstack-2025-08-28-18-58-45-image.webp)
