...
[afoim/acofork_forum_backend](https://github.com/afoim/acofork_forum_backend)

前端是一坨React

![](/img/concurrently-concurrently-1.png)

后端是一坨 Typescript

![](/img/concurrently-concurrently-2.png)

而前端要用 Vite 来 Dev

![](/img/concurrently-concurrently-3.png)

那么后端还要使用 Wrangler 来 Dev

![](/img/concurrently-concurrently-4.png)
...
![](/img/concurrently-concurrently-5.png)

![](/img/concurrently-concurrently-6.png)
