...
![](/img/umami-local-2-render-2025-08-28-10-03-34-image.webp)

右键需要备份的数据库，点击 **备份**

![](/img/umami-local-2-render-2025-08-28-10-03-58-image.webp)
...
> 
> ![](/img/umami-local-2-render-2025-08-28-10-06-39-2dfd6b861774ca0b05d460fc19bfccb1.webp)
...
![](/img/umami-local-2-render-2025-08-28-10-07-41-image.webp)

在 **pgAdmin4** 中，连接到Supabase数据库

![](/img/umami-local-2-render-2025-08-28-10-10-00-image.webp)
...
![](/img/umami-local-2-render-2025-08-28-10-12-10-image.webp)

选择刚才备份的数据库文件

![](/img/umami-local-2-render-2025-08-28-10-12-29-image.webp)
...
![](/img/umami-local-2-render-2025-08-28-10-25-05-image.webp)

而 **DATABASE_URL** 可以在 Supabase 中看到

![](/img/umami-local-2-render-2025-08-28-10-25-44-image.webp)
...
![](/img/umami-local-2-render-2025-08-28-10-29-02-image.webp)
...
![](/img/umami-local-2-render-2025-08-28-10-32-09-image.webp)

CORS配置详情

![](/img/umami-local-2-render-2025-08-28-10-32-32-image.webp)
