...
![](/img/self-host-matrix-2025-08-02-17-24-58-image.webp)

接着点击添加服务器

![](/img/self-host-matrix-2025-08-02-17-27-10-image.webp)

相关信息可以在连接信息看到

![](/img/self-host-matrix-2025-08-02-17-27-53-image.webp)

**删除**刚刚创建的 `synapse` 这个数据库

![](/img/self-host-matrix-2025-08-02-17-28-49-image.webp)

重新创建同名数据库

设置所有者（即用户名）为 `synapse` 

![](/img/self-host-matrix-2025-08-02-17-29-36-image.webp)
...
![](/img/self-host-matrix-2025-08-02-17-32-00-image.webp)
...
![](/img/self-host-matrix-2025-08-02-17-33-50-image.webp)
