...
![](/img/del-git-commit-del-git-commit-2.webp)
...
![](/img/del-git-commit-del-git-commit-4.webp)

可以看到，效果非常拔群， **微信密码.txt** 已经不翼而飞了

![](/img/del-git-commit-del-git-commit-3.webp)
...
![](/img/del-git-commit-del-git-commit-5.webp)
...
![](/img/del-git-commit-del-git-commit-6.webp)
...
![](/img/del-git-commit-del-git-commit-7.webp)

如果中途又停下来重复上面几步即可。最终，检查你的本地提交，确认要删除的提交已经不再存在。并且目前工作区的文件没有任何更改，仅更改了Git历史提交记录

![](/img/del-git-commit-del-git-commit-9.webp)
...
![](/img/del-git-commit-del-git-commit-10.webp)

新工单

![](/img/del-git-commit-del-git-commit-11.webp)

从我拥有或控制的存储库中删除数据

![](/img/del-git-commit-del-git-commit-12.webp)

删除其他数据

![](/img/del-git-commit-del-git-commit-13.webp)
