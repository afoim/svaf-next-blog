...
![](/img/disable-astro-generating-optimized-images-2025-09-10-06-46-49-image.webp)

![](/img/disable-astro-generating-optimized-images-2025-09-10-06-47-01-image.webp)

构建后的页面不再为全局webp，透传原始文件名、扩展名。但仍然保留了 `/_astro` 路径，依旧支持相对路径粘贴图片

![](/img/disable-astro-generating-optimized-images-d836b41fd85611972c2086a7064705bdb1b4ff7c.webp)

![](/img/disable-astro-generating-optimized-images-ff1314b1ab7d60bd9a49d6499db22cde23fb9f60.webp)
