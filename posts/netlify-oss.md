...
![](/img/netlify-oss-2025-08-09-12-30-32-image.webp)
...
![](/img/netlify-oss-2025-08-09-05-17-05-image.webp)

一天后收到已开通 `Open Source` 计划的邮件。如果没有通过也没关系，你可以直接回复这封邮件，带上你的疑问，注意使用英文

![](/img/netlify-oss-2025-08-09-05-17-36-image.webp)

账户也自动从 `Starter` 升级到了 `Open Source` 计划

![](/img/netlify-oss-2025-08-09-05-18-12-image.webp)
