...
draft: false
coverImage: /img/domain-email-2025-05-02-21-04-48-image.webp
---
...
![](/img/domain-email-2025-05-02-20-57-24-image.webp)

然后选择账号密码登录

![](/img/domain-email-2025-05-02-20-57-44-image.webp)

接着选择成员登录（如果直接进去了就跳过这一步）

![](/img/domain-email-2025-05-02-20-59-22-image.webp)

接下来左上角点击设置

![](/img/domain-email-2025-05-02-21-00-08-image.webp)

收发信设置

![](/img/domain-email-2025-05-02-21-00-31-image.webp)

这里就能查看到SMTP和IMAP的地址和端口（实测TLS也是支持的，只是它没写）

![](/img/domain-email-2025-05-02-21-01-07-image.webp)

## 生成客户端密码

接下来前往邮箱绑定

![](/img/domain-email-2025-05-02-21-01-36-image.webp)

生成新密码

![](/img/domain-email-2025-05-02-21-01-57-image.webp)
...
![](/img/domain-email-65e5b400-96d7-44c6-b16e-a7a409104c3c.webp)

如果你不喜欢你的账户名，比如我的就是 **erchashush** @acofork.freeqiye.com，这个erchashush其实是可以更改的

在组织机构管理中点击账号管理，选择新建账号

![](/img/domain-email-a20e7931-c460-4134-b1b0-0fee82f8a7fc.webp)

然后写一个你想要的别名。绑定手机填你的，因为第一次登录需要验证码验证，如果填错了直接删除即可

![](/img/domain-email-b9ac287d-ff90-4f8c-88ba-0d7bb1588f1c.webp)

然后我们需要给这个新账号提权，如果你想用superadmin登录后台的话

![](/img/domain-email-6f21feca-984d-444e-b80f-bf1a28e4cf79.webp)
...
![](/img/domain-email-2fa04b72-f0e7-43c0-9c2a-1daab62e67cb.webp)
...
![](/img/domain-email-614794bd-d84d-4b66-b816-1d6d6ce73727.webp)

签名和发件人头像可以通过手机的网易邮箱大师设置

![](/img/domain-email-57f759bc-46fb-4f99-b6bb-751464661240.webp)
