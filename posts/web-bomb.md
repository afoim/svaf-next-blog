...
![](/img/web-bomb-web-bomb-1.png)

当我们使用解压工具进行解压后就能得到这个巨大的原文件了

![](/img/web-bomb-web-bomb-2.png)
